...
- **Todo lo que se puede probar sin Snowflake funciona:** 133 tests de backend
  ...
  75 de 76 corridas e2e pasan (38 specs × 2 proyectos; la que falta es un `skip`
  intencional).
...
| E2E | `cd frontend && npm run e2e` | ✅ **57 passed, 1 skipped** (29 specs × 2 proyectos) al auditar; **63 passed, 1 skipped** (32 specs) tras la Fase 4; **75 passed, 1 skipped** (38 specs) tras las Fases 1 y 8. Ver nota de intermitencia abajo |
