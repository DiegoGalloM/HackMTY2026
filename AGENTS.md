...
backend/app/
  ...
  http_hardening.py    # body size limit (413), security headers, legacy /accounts routes off in production
backend/tests/golden/  # golden questions for the assistant (JSON), run by test_assistant_golden.py
